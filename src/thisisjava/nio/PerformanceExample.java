...
public class PerformanceExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Path from = Paths.get("src/thisisjava.nio/house.jpeg");
        Path to1 = Paths.get("src/thisisjava.nio/house1.jpeg");
        Path to2 = Paths.get("src/thisisjava.nio/house2.jpeg");
        ...
        fileChannel_from.position();    // 파일의 위치를 0으로 설정 - 처음으로 돌림
